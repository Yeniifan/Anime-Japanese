...
透過喜愛的動漫學日語！（目前支援 SPY×FAMILY 第一季全 24 集）

這是一個個人專案，讓你一邊閱讀 SPY×FAMILY 的台詞，一邊透過假名標注、單字查詢與填空練習提升日語能力。純靜態網站，無需後端。
