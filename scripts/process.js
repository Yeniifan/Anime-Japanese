...
if (!inputPath) {
  console.error('Usage: node process.js <input.txt> [output.json] [--episode S1E02] [--title "タイトル / English"]');
  process.exit(1);
}
...
const lines = parseTxt(inputPath);
console.log(`   → ${lines.length} dialogue lines`);
